...
public class StatisticService {
    ...
    public StatisticDTO updateFields(int id, Map<String, Object> updates) {
        ...
        Map<String, Consumer<Object>> updatesMap = Map.of(
                "matchsJoues", value -> stat.setMatchesPlayed((Integer) value),
                "buts", value -> stat.setGoals((Integer) value),
                "passesDecisives", value -> stat.setAssists((Integer) value),
                "taille", value -> stat.setHeight(Double.parseDouble(value.toString())),
                "poids", value -> stat.setWeight(Double.parseDouble(value.toString())),
                "cartonsJaunes", value -> stat.setYellowCards((Integer) value),
                "cartonsRouges", value -> stat.setRedCards((Integer) value)
        );
